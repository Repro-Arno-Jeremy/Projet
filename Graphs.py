...
def create_graph():
    ...
    ax.scatter(average_results.index, average_results, color="blue", marker="o", label="result")
    ax.plot(average_results_away.index, average_results_away, color="green", label="results_away")
    ax.scatter(average_results_away.index, average_results_away, color="green", marker="o", label="result_away")
